...
import { Shield, BookOpen, Target, TrendingUp } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-policial-azul to-policial-azulMedio text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-24 pb-16 text-center">
        ...
        <p className="text-lg text-blue-200 mb-10 max-w-2xl mx-auto">
          Material elaborado por un Policía Local en activo. 
          Supuestos reales, corrección detallada y feedback profesional 
          para que llegues al examen con la máxima preparación.
        </p>
        <Link
          to="/dashboard"
        ...
        {[
          {
            ...
            desc: 'Supuestos elaborados y supervisados por un Policía Local de Andalucía en activo, basados en normativa real y actualizada.',
          },
          {
            icon: Target,
            titulo: 'Corrección profesional',
            desc: 'Feedback detallado por infracción: artículo exacto, calificación, sanción y órgano sancionador competente.',
          },
          {
            icon: TrendingUp,
            titulo: 'Progreso real',
            desc: 'Identifica tus puntos débiles y enfoca el estudio donde más lo necesitas para llegar al examen con confianza.',
          },
